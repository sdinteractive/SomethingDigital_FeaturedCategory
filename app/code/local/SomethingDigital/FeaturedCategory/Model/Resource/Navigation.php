 ...
 * @package    SomethingDigital_FeaturedCategory
 */

class SomethingDigital_FeaturedCategory_Model_Resource_Navigation extends Mage_Catalog_Model_Resource_Category_Flat
{
    /**
